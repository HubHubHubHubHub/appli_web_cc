...
{#if visible}
	<aside class="grammar-sidebar card card-sm fixed right-2.5 top-1/2 -translate-y-1/2 z-grammar-sidebar bg-base-100 w-auto max-w-sm max-h-[85vh] overflow-y-auto text-sm leading-snug {$pinnedElement !== null ? 'border-primary shadow-grammar-pinned' : 'shadow-grammar'}" aria-label="Grammaire">
