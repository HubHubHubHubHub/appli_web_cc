...
<div class="max-w-3xl mx-auto p-6 text-[1.2rem]" style:zoom={uiStore.contentScale === 1 ? null : uiStore.contentScale}>
  ...
  {:else}
    <div class="empty-state">
      <svg class="empty-state-tryzub" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-62 10 124 205" fill="currentColor">
      ...
      <p class="empty-state-hint">Choisissez un mot dans la liste<br />pour explorer sa grammaire.</p>
    </div>
  {/if}
</div>
