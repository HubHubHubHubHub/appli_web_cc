...
| *(absent)* | Non tranche -- verification en cours | |
...
<span class="ukr" data-info="шостий;pos=adj;adjType=ord;notation=abbr;case=nom;gender=m;number=sg">6-й</span>
<!-- Epele -> шостий -->
```
...
interface MorphoTag {
  // Identite
  lemma: string;
  pos: "noun"|"verb"|"adj"|"pron"|"num"|"adv"|"prep"|"conj"|"part"|"intj"|"pred"|"insert"|"x";

  // Sous-types lexicaux
  nounType?: "common"|"proper";
  nounSubtype?: "fname"|"lname"|"toponym"|"city"|"country"|"ethnicity"|"language"|"animal"|"abbr";
  ...
  advType?: "manner"|"time"|"place"|"quantity"|"intensity"|"reason"|"inter"|"indef"|"dem"|"neg";
